/**
 * Issue #669: two labels that differ only in Italian gender agreement, or only in an enclitic
 * article, are one vocabulary question rather than two.
 *
 ...
 * questions, covering 27 relations, are that shape and nothing else.
 *
 * Every case here fails on 2ef81b0, where the two labels produce two proposals.
 */
