/**
 * `/w/[universe]/works/[work]/[node]`: a scene (or act/chapter/encounter) next to the
...
export const actions: Actions = {
	save: async ({ request, params, locals }) => {
		...
		redirect(303, `/w/${params.universe}/works/${params.work}/${node.id}`);
	},
	...
	addChild: async ({ request, params, locals }) => {
		...
		redirect(303, `/w/${params.universe}/works/${params.work}/${child.id}`);
	},
