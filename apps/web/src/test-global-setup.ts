...
// Resolved by the shared helper rather than here, because `vite.config.ts` has to reach the
// same answer and this file runs in a different process from the workers (issue #759).
